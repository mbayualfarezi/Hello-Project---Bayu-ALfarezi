...
from kivy.uix.screenmanager import ScreenManager, Screen #In order to change screens
...
class ConnectPage(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.cols = 2 #used four our grid

        #Read setting from text file, or use empty strings
        ...
        #idgeds added in order, so mind the order.
        ...
        self.join.bind(on_press=self.join_button) #things to happen when we press that button
    ...
    def join_button(self, instance):
        ...
        #save login-into some file text as login history
...
class ChatPage(GridLayout):
    def __init__(self, **kwargs):
        ...
        self.image = Button(text="Gambar")
        self.image.bind(on_press=self.send_image)
        self.send = Button(text="Kirim")
        ...
        bottom_line.add_widget(self.image)
    ...
    def incoming_message(self, username, message):
        ...
        self.history.update_chat_history(f'[color=20dd20]\n{username}[/color] : \n {time.ctime(time.time())} \n {message}')
    ...
    def send_message(self, _):
        ...
        if message:
            self.history.update_chat_history(f'[color=dd2020]\n{chat_app.connect_page.username.text}[/color] : \n{time.ctime(time.time())}\n {message}')
    ...
    def send_image(self, _):
        ...
        if message:
            ...
            socket_client.send_image(message)
